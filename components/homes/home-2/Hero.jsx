          ...
          <div className="col-12">
            <div className="content-inner">
              <div className="heading-title">
                <h1 className="title">Find Your Perfect Spot, in the Kasi.</h1>
                <p className="h6 fw-4">
                  Looking for a backroom, bachelor, flat, or full house? Smarzi brings the 
                  kasi property market straight to your fingertips. No more walking around or asking around. Search, 
                  compare, and secure your space in minutes.
                </p>
              </div>
