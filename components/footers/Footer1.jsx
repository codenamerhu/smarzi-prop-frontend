            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6">
                <div className="footer-menu-list newsletter ">
                  <h5 className="title lh-30 mb-19">Join the Waiting List.</h5>
                      ...
                      >
                        <div className="sib-form-message-panel__text sib-form-message-panel__text--center">
                          ...
                          <span className="sib-form-message-panel__inner-text">
                            Registeration could not be saved. Please try
                            again.
                          </span>
                        </div>
                      </div>
                        ...
                        <form onSubmit={sendEmail} id="sib-form">
                          <div className="sib-form-block ">
                            <div className="sib-text-form-block">
                              <p className="text-1">
                                The Future of local Property Search Is Loading. Get Early Access.
                              </p>
                            </div>
                          </div>
